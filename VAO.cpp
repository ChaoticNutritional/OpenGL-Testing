...
void VAO::LinkAttrib(VBO VBO, GLuint layout, GLuint numComponents, GLenum type, GLsizeiptr stride, void* offset)
{
	...
	// Configure the Vertex Attribute so that OpenGL knows how to Read the VBO
		// 1st param: Index of the vertex attribute currently examined
		...
		// 5th param: pointer to the first component of the first attribute. The offset in bytes from the beginning of each vertex in the buffer
			// (void*)0
	// this also essentially links our VBO's data INTO our VAO, and HOW OpenGL should do that linking while looking at bytes in a block of memory
